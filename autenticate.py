...
# Descrição pela ordem
# 1 - Permite ler e modificar arquivos no Google Drive
# 2 - Permite ler arquivos no Google Drive
# 3 - Permite ler metadados de arquivos no Google Drive
SCOPES = [
...
if not creds or not creds.valid:
    ...
    if creds and creds.expired and creds.refresh_token:
        ...
        # vai abrir o navegador para autorização
