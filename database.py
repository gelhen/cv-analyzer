...
class AnalyzeDatabase(TinyDB):
    def __init__(self, file_path='db.json') -> None:
        ...
        self.resums = self.table('resumes')
        self.analysis = self.table('analysis')
        self.files = self.table('files')

    # todas as tabelas foram criadas na pasta models
    ...
    def get_job_by_name(self, name):
        ...
        # é esperado retorno unico pega o primeio elemento da lista
    ...
    def get_analysis_by_job_id(self, job_id):
        ...
        # posso ter inumeras analises , retorno a lista
        return result
